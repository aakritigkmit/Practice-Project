...
import (
    ProductHandler "dynamo_db_crud/internal/handlers/product"
    ServerConfig "dynamo_db_crud/config"
    HealthHandler "github.com/aakritigkmit/Practice-Project/internal/handlers/health"
...
// func (r *Router) EnableLogger() a struct method
